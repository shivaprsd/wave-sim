...
function drawWave(time, d) {
    ...
    scr.strokeStyle = '#f24200'; // Set color for drawing the wave
    ...
    scr.fillStyle = '#f24200'; // Set color for drawing the wave
    scr.beginPath();             // Begins the wave
...
document.onkeypress = function() {
    ...
    if(document.activeElement.tagName !== 'INPUT' 
            ...
            startWave(); // Start/pause the wave if both conditions
                         // are satisfied
